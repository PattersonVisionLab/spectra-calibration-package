...
% --------------------------------------------------------------------------
    ...
    fprintf(fid,...
        'lut1 		= F:\\FunctionalImaging\\ExperimentParameters\\LUTs\\%s\r\n', lutFiles(1));
    fprintf(fid,...
        'lut2 		= F:\\FunctionalImaging\\ExperimentParameters\\LUTs\\%s\r\n', lutFiles(2));
    fprintf(fid,...
        'lut3 		= F:\\FunctionalImaging\\ExperimentParameters\\LUTs\\%s\r\n', lutFiles(3));
