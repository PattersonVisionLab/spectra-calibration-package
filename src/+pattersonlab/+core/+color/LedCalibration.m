...
% --------------------------------------------------------------------------
    ...
    methods
        function ax = plotCIE(obj, ledScalars)
            ...
            %
            % Description:
            %   Shows the location of the white point on a CIE diagram
            %
            % Syntax:
            %   ax = obj.plotCIE()
            % -------------------------------------------------------------
    ...
    methods
        function S = struct(obj)
            ...
            S.Files = struct(...
                'Spectra', string([obj.RED.getFileName_Spectra();...
                            obj.GREEN.getFileName_Spectra();...
                            obj.BLUE.getFileName_Spectra()]),...
                'LUT',     string([obj.RED.getFileName_LUT();...
                            obj.GREEN.getFileName_LUT();...
                            obj.BLUE.getFileName_LUT()]));

            S.Spectra.Wavelengths = obj.RED.wavelengths;
